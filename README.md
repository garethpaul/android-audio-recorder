...
The current baseline fixes duplicate playback dispatch from the play button. A
future pass should modernize Gradle, SDK levels, runtime permission handling,
