# Android Audio Make Root Override Protection
...
- Do not change recorder runtime behavior, permissions, dependencies,
  workflows, Android sources, resources, or deployment configuration.
- Do not weaken wrapper hashes or create local SDK or credential placeholders.
- Do not claim emulator, device, audio-hardware, or production verification.
...
- No Android SDK was configured, so lint, test, and assembly truthfully
  ...
  emulator, device, or audio-hardware result is claimed.
